...
namespace CoreAndFood.Controllers
{
    ...
    public class ChartController : Controller
    {
        ...
        {
            return Json(FoodList1());
        }
        public List<Class2> FoodList1()
        {
            List<Class2> cs1 = new List<Class2>();
            using (var c = new Context())
            {
                cs1 = c.Foods.Select(x => new Class2
                {
                    foodname = x.Name,
                    stock = x.Stock
                }).ToList();
        ...
        public IActionResult Statistics()
        {
            ...
            var deger4 = c.Foods.Where(x => x.CategoryID == c.Categories.Where(z => z.CategoryName ==
            "Vegatable").Select(y => y.CategoryID).FirstOrDefault()).Count();
            ViewBag.d4 = deger4;
            ...
            var deger6 = c.Foods.Where(x => x.CategoryID == c.Categories.Where(y => y.CategoryName ==
               "Legume").Select(z => z.CategoryID).FirstOrDefault()).Count();
            ViewBag.d6 = deger6;

            var deger7 = c.Foods.OrderByDescending(x => x.Stock).Select(y =>
                y.Name).FirstOrDefault();
            ViewBag.d7 = deger7;

            var deger8 = c.Foods.OrderBy(x => x.Stock).Select(y =>
              y.Name).FirstOrDefault();
            ViewBag.d8 = deger8;
            ...
            var deger11 = c.Categories.Where(x => x.CategoryName == "Vegatable").Select(y =>
                 y.CategoryID).FirstOrDefault();
